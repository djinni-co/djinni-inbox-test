    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture_url', models.CharField(blank=True, default='', max_length=255, null=True)),
                ...
                ('domain_zones', models.TextField(blank=True, default='')),
                ('uninterested_company_types', models.TextField(blank=True, default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_keyword', models.CharField(blank=True, default='', max_length=50)),
                ('secondary_keyword', models.CharField(blank=True, default='', max_length=50)),
                ('long_description', models.TextField(blank=True, default='')),
                ('extra_keywords', models.CharField(blank=True, default='', max_length=250)),
                ...
                ('company_type', models.CharField(blank=True, default='', max_length=20, null=True)),
                ('remote_type', models.CharField(blank=True, default='', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedback_candidate', models.CharField(blank=True, default='', max_length=20)),
                ...
                ('feedback_recruiter', models.CharField(blank=True, default='', max_length=20)),
                ...
                ('candidate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sandbox.candidate')),
                ('job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sandbox.jobposting')),
                ('last_message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sandbox.message')),
